package com.spilder.DemoSource;
 ...
 *
 */
public class GetEceryPicture {

    public static void main(String[] args) throws Exception {
        // 此处可改动图片存放位置
        // windows：默认d盘下的pictures目录； Mac：默认
        // File dir = new File("D:\\spilder\\prettygirl");
        File dir = new File("//Users//lijingwen//Downloads//picTest//spilder//download//");
        ...
        int no;
        String[] regex = {"http://www\\.mmonly\\.cc/mmtp/[a-zA-Z]+/\\d+\\.html\"><img",
                "http://www\\.mmonly\\.cc/mmtp/[a-z]+/\\d+"};
        String title_regex = "alt=\"[\\u4E00-\\u9FA5\\w\\s\\-]+\"\\ssrc=\"";
        String[] picture_regex = {"src=\"http://t1\\.huishahe\\.com/uploads/.+\\.jpg\" ",
                "http://t1\\.huishahe\\.com/uploads/.+\\.jpg"};
...
class Task implements Runnable {
    ...
    public Task(File dir, String url_str, int no, String[] regex, String title_regex, String[] picture_regex, int begin,
                int end) {
        this.dir = dir;
...
class WebsitList {
    ...
    // ^[u4E00-u9FA5a-zA-Z]{2,}$
    private static final String title_regex2 = "[\u4e00-\u9fa5\\w\\-]*[\u4e00-\u9fa5][\u4e00-\u9fa5\\w\\-]*";
    private static final Pattern title_pattern2 = Pattern.compile(title_regex2);
...
class DetailPage {
    private static final String page_regex = "\\u5171(\\d+)+\\u9875";
    private static final Pattern page_pattern = Pattern.compile("\\u5171(\\d+)+\\u9875");
    ...
    public void downloadAll(File dir) throws IOException {
        ...
        while (it.hasNext()) {
            try {
                ...
                System.out.println(title + ":" + src + "開始下载...");
